...
const AdminLogin = () => {
    ...
    return (
            ...
            <div className="page-wrapper">
                <div className="authentication-box">
                    <div className="container">
                        <div className="row">
                            <div className="col-md-5 mb-0 py-1  px-0 card-left">
                                <div className="card bg-primary  ">
                                    <div className="svg-icon">
                                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 468.52 468.52" style={{ enableBackground: 'new 0 0 468.52 468.52' }} xmlSpace="preserve">
                                            <g>
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z" />
                                    ...
                                    <div className="card-body">
                                        <ul className="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                            <li className="nav-item">
                                                <NavLink className="nav-link active" id="top-profile-tab" data-bs-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span className="icon-user me-2" />Login</NavLink>
                                            </li>
                                            <li className="nav-item">
                                            ...
                                            <div className="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                                <form className="form-horizontal auth-form">
                                                    <div className="form-group">
                                                        <input value={email} onChange={ (e) => setEmail(e.target.value) } name="email" className="form-control" placeholder="UserEmail" type="text" />
                                                    </div>
                                                    <div className="form-group">
                                                        <input value={password} onChange={ (e) => setPassword(e.target.value) }  name="password" type = "password"className="form-control" placeholder="Password" />
                                                    </div>
                                                    <div className="form-terms">
                                                        <div className="form-check mesm-2">
                                                            ...
                                                            <button className="btn btn-default border px-3 py-1 forgot-pass">Forgot Password!</button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="form-footer">
                                                        ...
                                                        <ul className="social">
                                                            <li><NavLink className="ti-facebook" href /></li>
                                                            <li><NavLink className="ti-twitter" href /></li>
                                                            <li><NavLink className="ti-instagram" href /></li>
                                                            <li><NavLink className="ti-pinterest" href /></li>
                                                        </ul>
                                                    </div>
                                                </form>
                                            </div>
                                                    ...
                                                    <div className="form-terms">
                                                        <div className="form-check mesm-2">
                                                            ...
                                                            <label className="form-check-label ps-2" htmlFor="customControlAutosizing1"><span>I agree all statements in
                                                                <NavLink href className="pull-right">Terms &amp;
                                                                    Conditions</NavLink></span></label>
                                                        </div>
                                                    </div>
                                                    <div className="form-button">
                        ...
                        <NavLink to={'/admin/dashboard'} className="btn btn-primary back-btn"><i data-feather="arrow-left" />back</NavLink>
                    </div>
                </div>
            </div>
